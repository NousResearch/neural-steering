#!/usr/bin/env python3
"""
Binary Yes/No Ablation Studies for Llama-3.2-1B
=================================================
Same protocol as other experiments.
"""
...
def run_random_control(steerer):
    ...
    # Handle nested text_config for multimodal models (Gemma4, etc.)
...
def main():
    ...
    steerer = NeuronSteerer(MODEL, dtype=torch.bfloat16, max_memory={0: "9GiB", 1: "9GiB"})
